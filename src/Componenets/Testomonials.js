  ...
  return (
    <div className='testomonial-bg '>
        ...
        <div>
            ...
            <div>
          <img className='p-5 mt-5 img-test' src={Arrows} alt=''></img>
            </div>
        ...
        <Card>
          <p className='p-sec'>"Never going back to waiting in lines! Shop smarter, get it delivered with QuickPik. It's that simple."</p> 
            <div className='d-flex m-3'>
                <img width="50px" height='50px' src={Ellipsegirl} alt=''></img>
                <div>
      ...
      <Card>
          ...
          <div className='d-flex m-3'>
                <img width="50px" height='50px'  src={Ellipsemen} alt=''></img>
                <div>
      ...
      <Col xs={12} md={4}>
        <Card>
          ...
          <div className='d-flex m-3'>
                <img width="50px" height='50px'  src={Ellipsecap} alt=''></img>
                <div>
